...
"")
        ...
        self.label.setStyleSheet("border-image: url(bg_photos/background.jpg);\n"
...
"padding-bottom:7px;")
    ...
    def clicked(self):
        print('Username \t:'+self.user.text())
        if self.user.text() == "kamlesh":
             if self.password.text() == "2022":  
                print("Welcome")
                pkg.classrun.home(Form)               
